...
public class HextechHammerCombinerSmithingTemplateItem extends SmithingTemplateItem {
    ...
    private static final Identifier EMPTY_SLOT_HEXTECH_HAMMER_HEAD;
    ...
    public HextechHammerCombinerSmithingTemplateItem(Text appliesToText, Text ingredientsText, Text baseSlotDescriptionText, Text additionsSlotDescriptionText, List<Identifier> emptyBaseSlotTextures, List<Identifier> emptyAdditionsSlotTextures, Settings settings) {
    ...
    static {
        ...
        EMPTY_SLOT_HEXTECH_HAMMER_HEAD = Identifier.ofVanilla("container/slot/empty_hammer_head");
    }
